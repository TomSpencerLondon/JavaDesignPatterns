...
public class Client {
	...
	public static void main(String[] args) {
		...
		visitOrgStructure(employees, visitor);

		// Retrieve and display the final ratings
		AppraisalVisitor.Ratings ratings = visitor.getFinalRatings();
		ratings.forEach((id, rating) -> System.out.println("Employee ID: " + id + ", Final Rating: " + rating.getFinalRating()));
		...
		visitOrgStructure(employees, printVisitor);
